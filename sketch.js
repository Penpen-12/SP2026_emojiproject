/**
  ...
  Project Description: This program is for creating an interactive emoji that can change eyes color,mouth and eyes movements with code.
  Last Modified: March 2, 2026
  */



  var constrainedX;// for setting mouth movements in X direction
  var constrainedY;// for setting mouth movements  in X direction 
  
  var constrinedX1; //for setting eye movement in X direction
  var contrainedY1; //for setting eye movement in Y direction
...
//Draw left eye
 ...
 //Draw left eyeball
  ...
  constrainedX1= constrain (mouseX,90,114)
  constrainedY1= constrain (mouseY,140,157)
  ellipse(constrainedX1,constrainedY1,10,10);
 ...
 //Draw right eyeball
  fill(value,mouseX,mouseY);
  constrainedX1= constrain (mouseX,240,254)
  constrainedY1= constrain (mouseY,140,157)
  ellipse(constrainedX1,constrainedY1,10,10);
